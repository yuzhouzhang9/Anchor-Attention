...
class LLMNeedleHaystackTester:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Logger.set_log_file_path(f"log/needle/{time.time()}")
        patch_model(self.model,self.config.pattern,self.config.pattern_config)
        Logger.log(f"config:{self.config}")
