...
from .modules.inf import InfLLMGenerator, inf_forward
from .modules.kv import (
    method_to_cache_obj,
    prepare_inputs_for_generation_kv,
)
...
from .ops.streaming import stream_llm_forward
from .model import causal_model_forward, glm_forward, prepare_input, update_kwargs
...
def patch_glm_4_1m(model, config):
    ...
    prepare_inputs_func = prepare_inputs_for_generation_kv(
...
def minference_patch_vllm_executor(config_file: str, patch_config={}):
    ...
    from baseline.minference.modules.attention import (
