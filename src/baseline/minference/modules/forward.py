...
from ..modules.flex import flex_forward
from ..modules.kivi import kivi_forward
from ..modules.attention import minference_prefill_forward
from ..modules.quest import quest_decode_kernel
from ..modules.retrieval import retrieval
from ..ops.streaming import a_shape_kernel, tri_shape_kernel
...
def attn_forward(
    ...
    if not use_cache or q_len == past_key_value.get_seq_length(
        ...
        # assert q_len == 1
        if decoding_forward is not None:  # eg, retrieval
            decoding_kwargs = {
                "layer_idx": self.layer_idx,
                "attn_forward_config": attn_forward_config,
                "position_ids": position_ids,
