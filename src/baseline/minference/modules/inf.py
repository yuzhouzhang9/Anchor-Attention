...
# Refer to the code in https://github.com/thunlp/InfLLM/blob/main/inf/attention/context_manager.py
...
try:
    ...
    from ..ops.flash import (
        _flash_decoding as dense_decoding_func,
    )

from ..ops.streaming import TritonMultiStageDotProductionAttention
